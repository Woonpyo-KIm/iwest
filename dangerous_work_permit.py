...
<h3 style="border-bottom: 2px solid #333; padding-bottom: 5px; margin-top: 15px; font-size: 16px; color: #000;">1. 작업 개요</h3>
<table style="width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 15px; color: #000;">
<tr><td style="padding: 4px 0;"><b>작업명:</b> {data['work_name']}</td></tr>
<tr><td style="padding: 4px 0;"><b>작업 장소:</b> {data['location']}</td></tr>
<tr><td style="padding: 4px 0;"><b>투입 작업자:</b> {data['workers']}</td></tr>
</table>

<h3 style="border-bottom: 2px solid #333; padding-bottom: 5px; margin-top: 15px; font-size: 16px; color: #000;">2. 필수 안전수칙 (TBM 전파사항)</h3>
...
<p style="font-size: 11px; line-height: 1.5; margin-bottom: 15px; color: #000;">
...
<h3 style="border-bottom: 2px solid #333; padding-bottom: 5px; margin-top: 15px; font-size: 16px; color: #000;">3. 환경 측정 기록</h3>
<table style="width: 100%; border-collapse: collapse; border: 1px solid #333; font-size: 12px; text-align: center; margin-bottom: 20px; color: #000;">
...
<h3 style="border-bottom: 2px solid #333; padding-bottom: 5px; margin-top: 15px; font-size: 16px; color: #000;">4. 작업 위험성평가(JSA) 및 안전대책</h3>
<table style="width: 100%; border-collapse: collapse; border: 1px solid #333; font-size: 12px; margin-bottom: 30px; color: #000;">
<thead>
<tr style="background-color: #f2f2f2;">
...
<h3 style="border-bottom: 2px solid #333; padding-bottom: 5px; font-size: 16px; color: #000;">[허가서 기재요령]</h3>
